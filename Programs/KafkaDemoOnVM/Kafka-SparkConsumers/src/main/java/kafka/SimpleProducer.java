...
* java -Djava.security.auth.login.config=/usr/hdp/2.4.2.0-258/kafka/config/kafka_client_jaas.conf -cp kafka-1.0-jar-with-dependencies.jar kafka.SimpleProducer -numMsgs 10 -topic test -brokers sandbox.hortonworks.com:6667 -file /root/kafka/picked_order_messages/picked_order_messagebody.txt -messagingMode Sync
spark-submit --class sparkStreaming.VM_Hive_Checkpoint /root/kafka/kafka-1.0-jar-with-dependencies.jar sandbox.hortonworks.com:6667 localhost:2181 samplekafkaconsumer KVJ1 1 /warehouse_dev/yj02/kafka test.KVJ_Topic_Offsets      2181 samplekafkaconsumer KVJ1 1 /warehouse_dev/yj02/kafka test.KVJ_Topic_Offsets
        ...
        if (messagingMode.equals("Sync")) {
            try {
                ...
                while ((sCurrentLine = br.readLine()) != null) {
                    ...
                    ProducerRecord<String, String> record = new ProducerRecord<>(topic, sCurrentLine);
